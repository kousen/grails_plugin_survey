                ...
                <table>
                    <thead>
                        <tr>
                   	        ...
                   	        <g:sortableColumn property="contributor" title="Contributor" />
                    ...
                    <g:each in="${commentList}" status="i" var="comment">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean:comment, field:'contributor')}</td>
                        
                            <td>${fieldValue(bean:comment, field:'comment')}</td>
                        
                            <td>${fieldValue(bean:comment, field:'plugin')}</td>
